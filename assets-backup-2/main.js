...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var ngx_sails__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-sails */ "./node_modules/ngx-sails/index.js");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth.service */ "./src/app/auth.service.ts");
...
var PostFormComponent = /** @class */ (function () {
    function PostFormComponent(sails, authService) {
        this.sails = sails;
        this.authService = authService;
    ...
    PostFormComponent.prototype.post = function () {
        ...
        if (this.newPost && this.newPost.replace(/\s/g, '').length) {
            ...
            this.sails.post('/post', post).subscribe(function (resp) {
                console.log(resp);
                //test if successful and emit post to timeline
                _this.posted.emit(resp.data);
            });
            console.log("Post: \n\"" + this.newPost + "\"");
    ...
    PostFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_sails__WEBPACK_IMPORTED_MODULE_2__["SailsClient"],
            _auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]])
    ], PostFormComponent);
...
/* harmony import */ var ngx_sails__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-sails */ "./node_modules/ngx-sails/index.js");
/* harmony import */ var _auth_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../auth.service */ "./src/app/auth.service.ts");
/* harmony import */ var _post_comment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../post-comment */ "./src/app/post-comment.ts");
...
var PostComponent = /** @class */ (function () {
    function PostComponent(sails, authService) {
        this.sails = sails;
        this.authService = authService;
    ...
    PostComponent.prototype.onComment = function (content) {
        ...
        this.sails.post('/comment', comment)
            ...
            _this.post.comments.unshift(resp.data);
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _post_comment__WEBPACK_IMPORTED_MODULE_4__["Post"])
...
var TimelineComponent = /** @class */ (function () {
    function TimelineComponent(sails) {
        this.sails = sails;
        this.posts = [];
    } // posts fetch service to populate timeline
    TimelineComponent.prototype.onPosted = function (post) {
        console.log('posted');
        this.posts.unshift(post);
    };
    TimelineComponent.prototype.ngOnInit = function () {
        var _this = this;
        // add to service be more concise
        this.connection = this.sails.on('post').subscribe(function (resp) {
            console.log('post event!', resp);
            switch (resp.verb) {
                case 'created':
                    _this.posts.unshift(resp.data);
                    break;
                default:
                    // unrecognised action error
                    console.log('unrecognised post event');
            }
        });
        this.sails.get('/post').subscribe(function (resp) {
            console.log('get chat', resp);
            _this.posts = resp.data.reverse();
        });
    };
